...
import { FiHome, FiUsers, FiFilter, FiSearch, FiArrowRight, FiStar, FiCheckCircle } from 'react-icons/fi';
...
const HostelsPage = () => {
  ...
  const filteredHostels = HOSTELS.filter(hostel => {
    ...
    const typeMatch = activeFilter === 'all' || 
                     (activeFilter === 'male' && hostel.type === 'male') ||
                     (activeFilter === 'female' && hostel.type === 'female');
    ...
    <div className="min-h-screen bg-black py-24 px-4 sm:px-6 relative overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          >
            Explore our campus accommodation options designed to provide comfort, safety, and a sense of community for all students.
          </motion.p>
        </div>
        ...
        {filteredHostels.length === 0 ? (
          ...
          >
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 max-w-md mx-auto">
              ...
              <h3 className="text-white text-xl font-medium mb-2">No hostels found</h3>
              ...
              >
                <div className="relative overflow-hidden h-64">
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 z-20">
                      ...
                      <div className="flex gap-1">
                        {[...Array(5)].map((_, i) => (
                          <FiStar 
                            key={i} 
                            className={`${
                              i < Math.floor(hostel.reviews.reduce((acc, review) => acc + review.rating, 0) / hostel.reviews.length) 
                                ? 'text-yellow-400' 
                                : 'text-gray-400'
                            } w-4 h-4`} 
                          />
                    ...
                    <h2 className="text-white text-2xl font-bold">{hostel.name}</h2>
                  </div>
                </div>
                
                <div className="p-6">
                  <p className="text-gray-300 mb-6">{hostel.shortDescription}</p>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-white font-medium">{hostel.totalRooms}</p>
                      </div>
                    </div>
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center mr-3">
                      ...
                      <div>
                        ...
                        <p className="text-white font-medium">{hostel.totalCapacity} students</p>
                      </div>
                    </div>
                  </div>
                  
                  <div className="mb-6">
                    <h3 className="text-white text-lg font-medium mb-3">Key Facilities</h3>
                    <div className="grid grid-cols-2 gap-2">
                      {hostel.facilities.slice(0, 4).map((facility, i) => (
                        <div key={i} className="flex items-center">
                          <FiCheckCircle className="text-blue-400 mr-2 flex-shrink-0" />
                          <span className="text-gray-300 text-sm">{facility.name}</span>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">Hostel Allocation Process</h2>
              <p className="text-gray-300 mb-4">
                Hostel allocation is based on various factors including distance from hometown, academic performance, and specific requirements.
              </p>
              <ul className="space-y-3">
                <li className="flex items-start">
                  <FiCheckCircle className="text-blue-400 mt-1 mr-2 flex-shrink-0" />
                  <span className="text-gray-300">Applications open at the beginning of each academic year</span>
                </li>
                <li className="flex items-start">
                  <FiCheckCircle className="text-blue-400 mt-1 mr-2 flex-shrink-0" />
                  <span className="text-gray-300">Current students can apply through the student portal</span>
                </li>
                <li className="flex items-start">
                  <FiCheckCircle className="text-blue-400 mt-1 mr-2 flex-shrink-0" />
                  <span className="text-gray-300">New students receive application details with their admission offer</span>
                </li>
                <li className="flex items-start">
                  <FiCheckCircle className="text-blue-400 mt-1 mr-2 flex-shrink-0" />
                  <span className="text-gray-300">Priority is given to students from distant locations</span>
                </li>
              </ul>
            ...
            <div className="relative">
              ...
              <div className="relative bg-black/50 backdrop-blur-sm rounded-2xl p-6 border border-white/10">
                <h3 className="text-xl font-bold text-white mb-4">Hostel Management Contact</h3>
                <div className="space-y-4">
                  <div>
                    <p className="text-gray-400 text-sm">Hostel Administration Office</p>
                    <p className="text-white">Student Services Building, Ground Floor</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-white">Monday to Friday: 9:00 AM - 5:00 PM</p>
                  </div>
                </div>
              </div>
            </div>
