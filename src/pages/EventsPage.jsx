      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {loading ? (
          <div className="flex justify-center items-center py-20">
            <div className="w-12 h-12 border-t-4 border-b-4 border-purple-500 rounded-full animate-spin"></div>
          </div>
        ) : error ? (
          <div className="text-center py-16">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 max-w-md mx-auto">
              ...
              <h3 className="text-white text-xl font-medium mb-2">Error Loading Events</h3>
          ...
          <>
            ...
            {searchQuery === '' && activeCategory === 'all' && timeFilter === 'all' && !showFeaturedOnly && featuredEvents.length > 0 && (
              <motion.div 
                className="mb-8"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            {/* Upcoming Events Section (visible when no search or filters) */}
            {searchQuery === '' && activeCategory === 'all' && timeFilter === 'all' && !showFeaturedOnly && upcomingEvents.length > 0 && (
              <motion.div 
                className="mb-12"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            {/* Main Event Grid - Shows when filters are applied or always if there are no featured/upcoming events */}
            <motion.div 
              className="mb-12"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              {/* Title & Result Count - Only show when filters are applied */}
